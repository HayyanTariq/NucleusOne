...
interface AdminFormSlideoutProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (adminData: AdminFormData) => void;
}

export const AdminFormSlideout: React.FC<AdminFormSlideoutProps> = ({
  isOpen,
  onClose,
  onSubmit
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${formData.firstName} ${formData.lastName} has been added as an administrator.`,
      });
